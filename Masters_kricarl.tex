...
\covercaption{A voronoi tesselation containing 1000 polyhedras bounded by the unit box. Rendered with the Neper software.}
...
\subfile{chapters/generate_interface_elements}
