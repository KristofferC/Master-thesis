...
\coverfigure{\includegraphics[width=\textwidth,height=0.4\paperheight,keepaspectratio]{figures/Grains2}}
\covercaption{A voronoi tesselation in 3D bounded by the unit box. Rendered with the Neper software}
...
\addbibresource{Masters_kricarl.bib} % New comnand, use if available
