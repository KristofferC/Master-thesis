...
\covercaption{A Voronoi tesselation of a cube containing 1000 grains. Rendered with the Neper software.}

\firstabstract{\subfile{chapters/abstract}}
%\secondabstract{swedish}{\lipsum} % Optional
\keywords{Two phase duplex steel, Voronoi tesselation, Grain structure, etc etc}
