...
\node [b] (a1) [draw, minimum width=3.5cm,minimum height=2.5cm] {device $1$};
\node [b] (a2) [draw, minimum width=3.5cm,minimum height=2.5cm,below of=a1,node distance=4cm] {device $2$};
\node [b] (a3) [draw, minimum width=3.5cm,minimum height=2.5cm,below of=a2,node distance=4cm] {device $3$};
\node [b] (duplicate) [draw, minimum width=3.5cm,minimum height=2.5cm,below of=a2,node distance=4cm] {};
